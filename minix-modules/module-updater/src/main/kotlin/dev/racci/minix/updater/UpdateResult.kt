...
public enum class UpdateResult(public val isSuccessful: Boolean = false) {
    ...
    /** The updater found an update and was able to download it but didn't extract it. */
    FAILED_EXTRACTION,
    ...
    /** The updater was unable to back up the plugin folder. */
    FAILED_BACKUP,

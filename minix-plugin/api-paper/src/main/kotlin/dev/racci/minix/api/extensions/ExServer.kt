...
/** @see [Server.getOfflinePlayer] */
public fun offlinePlayer(
    uuid: UUID
): OfflinePlayer = server.getOfflinePlayer(uuid)

/** @see [Server.getOfflinePlayer] */
public fun offlinePlayer(
    name: String
): OfflinePlayer = server.getOfflinePlayer(name)

/** @see [Server.getOfflinePlayerIfCached] */
public fun cachedOfflinePlayer(
    name: String
): OfflinePlayer? = server.getOfflinePlayerIfCached(name)
...
public fun playerExact(
    name: String
): Player? = server.getPlayerExact(name)

/** @see [Server.matchPlayer] */
public fun matchPlayer(
    name: String
): List<Player> = server.matchPlayer(name)

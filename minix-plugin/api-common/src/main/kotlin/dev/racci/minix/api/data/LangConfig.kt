...
@ConfigSerializable
public abstract class LangConfig<P : MinixPlugin> : MinixConfig<P>(false) {

    public abstract val prefixes: Map<String, String>
    ...
    @ConfigSerializable
    public open class InnerLang : PropertyFinder<PartialComponent>(KeyMode.CAPITAL_TO_DOT), InnerConfig by InnerConfig.Default()
}

...
constructor(
    ...
    public override val name: String = "Jenkins"
    public override val latestChecksum: String? get() = lastResult?.checksum
    public override val latestChangelog: String? get() = lastResult?.changelog
    public override val providesChangelog: Boolean get() = true
    public override val providesChecksum: ChecksumType get() = ChecksumType.MD5
    public override val providesUpdateHistory: Boolean get() = false // TODO

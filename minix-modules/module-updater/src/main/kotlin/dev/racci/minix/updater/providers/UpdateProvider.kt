...
import dev.racci.minix.api.updater.providers.SpigotUpdateProvider
...
public sealed class UpdateProvider : KoinComponent {

    public val logger by lazy { getKoin().get<Minix>().log }

    /**
     * @return The name of the update provider.
     */
    public open val name: String by lazy { this::class.simpleName ?: "null" }
...
//    @get:Throws(NotSuccessfullyQueriedException::class)
    public abstract val latestVersion: Version?
    ...
    public open val latestFileURL: URL? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide a file url!")
     ...
     */
//    @get:Throws(NotSuccessfullyQueriedException::class)
    public abstract val latestFileName: String?
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class /*NotSuccessfullyQueriedException::class*/)
    public open val latestName: String? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide a name!")
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val latestMinecraftVersion: String? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide a minecraft version!")
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val latestMinecraftVersions: Array<String>? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide any minecraft versions!")
     ...
     */
    @get:Throws(NotSuccessfullyQueriedException::class)
    public abstract val latestReleaseType: ReleaseType?
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val latestChecksum: String? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide a checksum!")
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val latestChangelog: String? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide a changelog!")
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val latestDependencies: Array<UpdateFile>? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide any dependencies!")
     ...
     */
    @get:Throws(RequestTypeNotAvailableException::class, NotSuccessfullyQueriedException::class)
    public open val updateHistory: Array<UpdateFile>? get() = throw RequestTypeNotAvailableException("The $name update provider does not provide an update history!")

    public open val providesDownloadURL: Boolean get() = false
    public open val providesMinecraftVersion: Boolean get() = false
    public open val providesMinecraftVersions: Boolean get() = false
    public open val providesChangelog: Boolean get() = false
    public open val providesChecksum: ChecksumType get() = ChecksumType.NONE
    public open val providesUpdateHistory: Boolean get() = false
    public open val providesDependencies: Boolean get() = false
     ...
     */
    public abstract suspend fun query(): UpdateResult
    ...
    public abstract suspend fun connect(url: URL): HttpResponse?

    public class InvalidUpdateProviderException(
        message: String? = null,
    ...
    public data class UpdateFile(
        ...
        override fun toString(): String = "UpdateFile(downloadURL=$downloadURL, name=$name, fileName=$fileName, checksum=$checksum, changelog='$changelog', gameVersion=$gameVersion, version=$version, gameVersions=$gameVersions)"
    }

    public class UpdateProviderSerializer : TypeSerializer<UpdateProvider> {
        ...
        public companion object {
            public val serializers: TypeSerializerCollection = TypeSerializerCollection.builder().register(UpdateProviderSerializer()).build()

            public suspend fun HttpResponse.getBuffered(): BufferedReader = bodyAsChannel().toInputStream().bufferedReader()

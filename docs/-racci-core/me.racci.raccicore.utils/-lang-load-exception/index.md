//[RacciCore](../../../index.md)/[me.racci.raccicore.api.utils](../index.md)/[LangLoadException](index.md)

# LangLoadException

[jvm]\
class [LangLoadException](index.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) : [Exception](https://docs.oracle.com/javase/8/docs/api/java/lang/Exception.html)
...
| | |
|---|---|
| [LangLoadException](-lang-load-exception.md) | [jvm]<br>fun [LangLoadException](-lang-load-exception.md)(message: [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)) |

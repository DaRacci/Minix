...
[jvm]\
class [PlayerRightClickEvent](index.md)(player: Player, usedItem: ItemStack?, clickedLocation: Location?, clickedBlock: Block?, clickedBlockFace: BlockFace?, clickedEntity: Entity?) : [KotlinEvent](../-kotlin-event/index.md)
...
| | |
|---|---|
| [PlayerRightClickEvent](-player-right-click-event.md) | [jvm]<br>fun [PlayerRightClickEvent](-player-right-click-event.md)(player: Player, usedItem: ItemStack?, clickedLocation: Location?, clickedBlock: Block?, clickedBlockFace: BlockFace?, clickedEntity: Entity?)<br>Create empty Player right click event |

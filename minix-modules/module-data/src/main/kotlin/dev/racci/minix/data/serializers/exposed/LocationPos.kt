...
public fun Entity<*>.locationPos(column: Column<String>): LocationPosExposedDelegate = LocationPosExposedDelegate(column)
public fun Entity<*>.nullableLocationPos(column: Column<String?>): LocationPosExposedDelegateNullable = LocationPosExposedDelegateNullable(column)
...
): LocationPosMultiColumnExposedDelegate = LocationPosMultiColumnExposedDelegate(xColumn, yColumn, zColumn, yawColumn, pitchColumn)
...
public fun Entity<*>.locationPos(
    ...
    yawColumn: Column<Float?>,
    pitchColumn: Column<Float?>
): LocationPosMultiColumnExposedDelegateNullable = LocationPosMultiColumnExposedDelegateNullable(xColumn, yColumn, zColumn, yawColumn, pitchColumn)

...
public object EmptyMultiMap : MultiMap<Any?, Nothing> {
    ...
    override fun forEach(block: (Any?, Collection<Nothing>?) -> Unit): Unit = Unit

    override fun forEachIndexed(block: (index: Int, Any?, Collection<Nothing>?) -> Unit): Unit = Unit
}

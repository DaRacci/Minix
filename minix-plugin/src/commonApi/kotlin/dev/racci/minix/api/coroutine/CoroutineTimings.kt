 ...
 */
public abstract class CoroutineTimings : AbstractCoroutineContextElement(CoroutineTimings), Runnable {
    /**
     * Key identifier of the context element.
     */
    public companion object Key : CoroutineContext.Key<CoroutineTimings>

    /**
     *  Multiple tasks can be assigned to a single coroutine. We implement this by a queue.
     */
    public var queue: Queue<Runnable> = ConcurrentLinkedQueue()

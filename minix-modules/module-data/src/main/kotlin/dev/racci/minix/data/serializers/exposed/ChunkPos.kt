...
public fun Entity<*>.chunkPos(column: Column<String>): ChunkPosExposedDelegate = ChunkPosExposedDelegate(column)
public fun Entity<*>.nullableChunkPos(column: Column<String?>): ChunkPosExposedDelegateNullable = ChunkPosExposedDelegateNullable(column)

public fun Entity<*>.chunkPos(
    xColumn: Column<Int>,
    zColumn: Column<Int>
): ChunkPosMultiColumnExposedDelegate = ChunkPosMultiColumnExposedDelegate(xColumn, zColumn)

public fun Entity<*>.chunkPos(
    xColumn: Column<Int?>,
    zColumn: Column<Int?>
): ChunkPosMultiColumnExposedDelegateNullable = ChunkPosMultiColumnExposedDelegateNullable(xColumn, zColumn)
